...
use RebelCode\Spotlight\Nft\Utils\Functions;
...
class NoticesManager
{
    ...
    {
        wp_enqueue_script('snft-admin-notices', $this->script, ['jquery'], SNFT_VERSION, true);

        wp_localize_script('snft-admin-notices', 'SnftNoticesL10n', [
