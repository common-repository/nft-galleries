...
namespace RebelCode\Spotlight\Nft\RestApi\EndPoints;

use Dhii\Transformer\TransformerInterface;
use Exception;
use InvalidArgumentException;
use RebelCode\Spotlight\Nft\RestApi\Transformers\CamelCaseTransformer;
use RebelCode\Spotlight\Nft\RestApi\Transformers\CompositeTransformer;
use RebelCode\Spotlight\Nft\RestApi\Transformers\RecursiveToArrayTransformer;
...
abstract class AbstractEndpointHandler
{
    ...
    protected function sendError($code, $message = '', $file = '', $line = 0)
    {
        ...
        if (
            ...
            $message = "Exhausted {$megaBytes}Mb of memory. To fix this problem, kindly clear the cache from the \"Settings > Tools\" page and then try again.";
        }
